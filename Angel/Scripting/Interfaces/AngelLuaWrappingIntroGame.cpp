...
static int _wrap_Message_GetSender(lua_State* L) {
  ...
  result = (MessageListener *)(arg1)->GetSender();
  {
    ...
    /*@SWIG:C:\Users\Canaan\Desktop\angel-engine\Code\Tools\swigwin-2.0.6\Lib\typemaps\swigmacros.swg,192,%_formacro_1@*//*@SWIG:C:\Users\Canaan\Desktop\angel-engine\Code\Tools\swigwin-2.0.6\Lib\lua\factory.i,7,%_factory_dispatch@*/ 
    if (!dcast) {
